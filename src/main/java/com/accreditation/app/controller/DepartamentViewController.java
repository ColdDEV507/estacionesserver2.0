...
import com.estacionesserver.model.DepartamentView;
import com.estacionesserver.repository.DepartamentViewRepository;
...
// </editor-fold>
    ...
    public Long countLikeByDepartament(@QueryParam("departament") String departament) {
        Long result = 0L;
        try {          
            result = departamentViewRepository.countLikeByDepartament(departament);
        } catch (Exception e) {
            MessagesUtil.error(MessagesUtil.nameOfClassAndMethod() + "error: " + e.getLocalizedMessage());
        }
        return result;
