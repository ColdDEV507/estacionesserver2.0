...
import com.estacionesserver.model.Applicative;
import com.estacionesserver.model.History;
import com.estacionesserver.repository.ApplicativeRepository;
...
// </editor-fold>
    ...
    public Applicative findByIdapplicative(
        ...
        Optional<Applicative> a = applicativeRepository.findByPk(idapplicative);
        if (a.isPresent()) {
            System.out.println("encontro " + a.get().getApplicative());
        } else {
            System.out.println(" no encuentra con id " + idapplicative);
        }
...
// </editor-fold>
    ...
    public Long countLikeByApplicative(@QueryParam("applicative") String applicative) {
        ...
        try {
            ...
            result = applicativeRepository.countLikeByApplicative(applicative);
    ...
    public List<Applicative> likeByApplicative(@QueryParam("applicative") String applicative) {
        ...
        try {
            ...
            suggestions = applicativeRepository.likeByApplicative(applicative);
