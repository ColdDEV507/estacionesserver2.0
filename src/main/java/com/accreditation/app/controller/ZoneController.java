...
import com.estacionesserver.model.Zone;
import com.estacionesserver.repository.HistoryRepository;
import com.estacionesserver.repository.ZoneRepository;
...
// </editor-fold>
    ...
    public Long countLikeByZone(@QueryParam("zone") String zone) {
        ...
        try {
            ...
            result = zoneRepository.countLikeByZone(zone);
    ...
    public List<Zone> likeByZone(@QueryParam("zone") String zone) {
        ...
        suggestions = zoneRepository.likeByZone(zone);
