...
import com.estacionesserver.model.District;
import com.estacionesserver.model.History;
import com.estacionesserver.repository.DistrictRepository;
...
// </editor-fold>
    ...
    public Response delete(
            @Parameter(description = "El elemento iddistrict", required = true, example = "1", schema = @Schema(type = SchemaType.NUMBER)) @PathParam("iddistrict") Long iddistrict) {
...
// </editor-fold>
    ...
    public Long countLikeByDistrict(@QueryParam("district") String district) {
        ...
        try {
            ...
            result = districtRepository.countLikeByDistrict(district);
    ...
    public List<District> likeByDistrict(@QueryParam("district") String district) {
        ...
        suggestions = districtRepository.likeByDistrict(district);
