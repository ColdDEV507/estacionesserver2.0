...
import com.estacionesserver.repository.OtpRepository;
...
// </editor-fold>
        ...
        // <editor-fold defaultstate="collapsed" desc="List<Otp> findByOtp(@QueryParam("otp") final String otp)">

    @GET
    @RolesAllowed({"admin"})
    @Path("otp")
    @Operation(summary = "Busca un opt por el otp", description = "Busqueda de otp por otp")
    ...
    public List<Otp> findByOtp(@QueryParam("otp") final String otp) {
...
//// </editor-fold>  
    ...
    @RolesAllowed({"admin"})
    @Path("iduser")
    @Operation(summary = "Busca un opt por el iduser", description = "Busqueda de otp por iduser")
    @APIResponse(responseCode = "200", description = "El user")
    @APIResponse(responseCode = "404", description = "Cuando no existe el username")
    @APIResponse(responseCode = "500", description = "Servidor inalcanzable")
    @Tag(name = "BETA", description = "Esta api esta en desarrollo")
    ...
    public List<Otp> findByIduser(@QueryParam("iduser") final Long iduser) {
        ...
        return otpRepository.findByIduser(iduser);
    }
// </editor-fold>  
    
// <editor-fold defaultstate="collapsed" desc="List<Otp> findByEmail(@QueryParam("email") final String email)">
