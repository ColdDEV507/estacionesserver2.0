...
import com.estacionesserver.model.Province;
import com.estacionesserver.repository.HistoryRepository;
import com.estacionesserver.repository.ProvinceRepository;
...
// </editor-fold>
    ...
    public Long countLikeByProvince(@QueryParam("province") String province) {
        ...
        try {
            ...
            result = provinceRepository.countLikeByProvince(province);
    ...
    public List<Province> likeByProvince(@QueryParam("province") String province) {
        ...
        suggestions = provinceRepository.likeByProvince(province);
