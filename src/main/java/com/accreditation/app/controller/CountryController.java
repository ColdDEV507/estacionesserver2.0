...
import com.estacionesserver.model.Country;
import com.estacionesserver.model.History;
import com.estacionesserver.repository.CountryRepository;
...
// </editor-fold>
    ...
    public Response delete(
            @Parameter(description = "El elemento idcountry", required = true, example = "1", schema = @Schema(type = SchemaType.STRING)) @PathParam("idcountry") String idcountry) {
...
// </editor-fold>
    ...
    public Long countLikeByCountry(@QueryParam("country") String country) {
        ...
        try {
            ...
            result = countryRepository.countLikeByCountry(country);
    ...
    // </editor-fold>
      // <editor-fold defaultstate="collapsed" desc="List<Country> likeByRole(@QueryParam("role") String role)">
    ...
    public List<Country> likeByCountry(@QueryParam("country") String country) {
        ...
        suggestions = countryRepository.likeByCountry(country);
