...
import com.estacionesserver.model.Township;
import com.estacionesserver.repository.HistoryRepository;
import com.estacionesserver.repository.TownshipRepository;
...
// </editor-fold>
    ...
    public Long countLikeByTownship(@QueryParam("township") String township) {
        ...
        try {
            ...
            result = townshipRepository.countLikeByTownship(township);
    ...
    public List<Township> likeByTownship(@QueryParam("township") String township) {
        ...
        suggestions = townshipRepository.likeByTownship(township);
