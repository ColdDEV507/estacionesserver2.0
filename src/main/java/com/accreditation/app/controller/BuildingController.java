...
import com.estacionesserver.model.Building;
import com.estacionesserver.model.History;
import com.estacionesserver.repository.BuildingRepository;
...
// </editor-fold>
    ...
    public Long countLikeByBuilding(@QueryParam("building") String building) {
        ...
        try {
            ...
            result = buildingRepository.countLikeByBuilding(building);
    ...
    public List<Building> likeByBuilding(@QueryParam("building") String building) {
        ...
        suggestions = buildingRepository.likeByBuilding(building);
