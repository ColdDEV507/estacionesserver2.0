...
import com.estacionesserver.model.Institution;
import com.estacionesserver.repository.HistoryRepository;
import com.estacionesserver.repository.InstitutionRepository;
...
// </editor-fold>
    ...
    public Long countLikeByInstitution(@QueryParam("institution") String institution) {
        ...
        try {
            ...
            result = institutionRepository.countLikeByInstitution(institution);
    ...
    public List<Institution> likeByInstitution(@QueryParam("institution") String institution) {
        ...
        suggestions = institutionRepository.likeByInstitution(institution);
